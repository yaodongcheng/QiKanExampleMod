...
# 🔴 主目录（SteamLibrary）= latest，跟随 Steam 官方更新——版本号不写死，实测以 Version.xml 为准（2026-09-08 实测 v1.5.2，之后随时更新）
TARGETS = {
...
def main():
    ...
    if not ver:
        ...
        print("或命令行执行: python set_mb2_path.py <1.5.2|1.4.8|1.3.15|1.2.12>")
        return
