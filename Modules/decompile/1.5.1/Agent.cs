...
public sealed class Agent : DotNetObject, IAgent, IFocusable, IUsable, IFormationUnit, ITrackableBase
{
	...
	public uint ClothingColor1
	{
		get
		{
			...
			TaleWorlds.Library.Debug.FailedAssert("Clothing color is not set.", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\Agent.cs", "ClothingColor1", 1195);
	...
	public float GetBaseArmorEffectivenessForBodyPart(BoneBodyPartType bodyPart)
	{
		...
		case BoneBodyPartType.ShoulderRight:
			return GetAgentDrivenPropertyValue(DrivenProperty.ArmorTorso);
		default:
			TaleWorlds.Library.Debug.FailedAssert("false", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\Agent.cs", "GetBaseArmorEffectivenessForBodyPart", 3283);
			return GetAgentDrivenPropertyValue(DrivenProperty.ArmorTorso);
		}
	}
	...
	public float GetDistanceTo(Agent other)
	{
		if (other == null)
		{
			TaleWorlds.Library.Debug.FailedAssert("Comparing distance with null agent", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\Agent.cs", "GetDistanceTo", 3794);
			return 0f;
		}
	...
	private void HandleBlow(ref Blow b, in AttackCollisionData collisionData)
	{
		...
		if (Controller == AgentControllerType.AI && Formation != null)
		{
			if (!agent.IsMount)
			{
