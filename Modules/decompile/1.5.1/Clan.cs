...
public sealed class Clan : MBObjectBase, IFaction
{
	...
	[SaveableField(140)]
	private bool _hasBloodFeudWithPlayer;

	[SaveableField(141)]
	public int BloodFeudExecutionsReceivedCount;

	[SaveableField(142)]
	public int BloodFeudExecutionsDoneCount;
	...
	public bool HasBloodFeudWithPlayer
	{
		get
		{
			return _hasBloodFeudWithPlayer;
		}
		set
		{
			_hasBloodFeudWithPlayer = value;
		}
	}
	...
	internal static object AutoGeneratedGetMemberValueBloodFeudExecutionsReceivedCount(object o)
	{
		return ((Clan)o).BloodFeudExecutionsReceivedCount;
	}

	internal static object AutoGeneratedGetMemberValueBloodFeudExecutionsDoneCount(object o)
	{
		return ((Clan)o).BloodFeudExecutionsDoneCount;
	}
	...
	internal static object AutoGeneratedGetMemberValue_hasBloodFeudWithPlayer(object o)
	{
		return ((Clan)o)._hasBloodFeudWithPlayer;
	}
