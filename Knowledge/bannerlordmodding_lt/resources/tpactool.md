...
<!-- 源: https://docs.bannerlordmodding.lt/resources/tpactool/ | 抓取日期: 2026-09-09 -->
...
* [Another fork](https://github.com/Wuan23/TpacTool)
* [TpacToolMax](https://www.patreon.com/ironmoddingbannerlord/posts/tpac-tool-max-166609999) - [Downlad](https://www.patreon.com/ironmoddingbannerlord/posts/tpactool-max-167121251)
...
![](https://docs.bannerlordmodding.lt/pics/2410020910.png)

Select Model and enter the mesh's name for the model you are searching (sturgia\_helmet\_c in example), select it in the found results:

![](https://docs.bannerlordmodding.lt/pics/2410020911.png)

If it's Rigged, select Rigged, Human skeleton (if it's human, could be horse, etc). Select if you need textures and then export:

![](https://docs.bannerlordmodding.lt/pics/2410020911b.png)

.obj files often are not imported into Blender properly. Try .dae instead. Select in the file window -> Save as type: COLLADA (\*.dae)

If crashing - Try to export without textures and with all the LODs.

## Textures

Example exported textures:

![](https://docs.bannerlordmodding.lt/pics/2410081307.png)
...
![](https://docs.bannerlordmodding.lt/pics/2410081508.png)

## Animations

Can't export an animation I want to export. How do I do it? Always get this error:

![](https://docs.bannerlordmodding.lt/pics/2604020815.png)
...
Tpac tool changes the vertex paint, which in case of crossbows need to be blue instead of red.

![](https://docs.bannerlordmodding.lt/pics/2508062236.png)
