...
<!-- 源: https://docs.bannerlordmodding.lt/resources/native_texture_exporter/ | 抓取日期: 2026-09-09 -->

Primarily intended as a quick fix for black textures that appear in custom scenes.

<https://github.com/JoeFwd/Bannerlord.NativeTextureExporter> by Eagle (Joël Forward)
...
* Copies the required native textures (DDS or PNG) into /AssetSources/vanilla\_texture\_reimports.
...
![](https://docs.bannerlordmodding.lt/pics/2512011320.png)

* Now you can go to the Editor and reimport the textures.

To be safe, I changed the texture names, imported and assigned them to the custom materials.
