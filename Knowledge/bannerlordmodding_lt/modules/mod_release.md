...
<!-- 源: https://docs.bannerlordmodding.lt/modules/mod_release/ | 抓取日期: 2026-09-09 -->
...
[Exporting the Module via the Modding Tools](https://moddocs.bannerlord.com/steam-workshop/uploading_updating_mod/#exporting-the-module-via-the-modding-tools) packs Assets/AssetSources/RuntimeDataCache into AssetPackages/pack0.tpac

![](https://docs.bannerlordmodding.lt/pics/bFhf0d8.png)
...
### [DependedModuleMetadatas](https://github.com/BUTR/Bannerlord.BUTRLoader#for-modders)
...
![](https://docs.bannerlordmodding.lt/pics/KukQAvR.png)

### Primary image

![](https://docs.bannerlordmodding.lt/pics/MN1lY54.png)
...
[Preparing Your Module For Publishing](https://moddocs.bannerlord.com/steam-workshop/uploading_updating_mod/)

Notes

* If you have a custom map, you'd need to patch the path to the settlements\_distance\_cache.bin in the SettlementPositionScript. It does not format the steam workshop file path correctly.
...
* Steam does not scan for malicious code in the mods (Nexus does). [You can get easily infected](https://forums.taleworlds.com/index.php?threads/malicious-mod-on-steam-workshop.470672/).
