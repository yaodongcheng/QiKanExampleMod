...
<!-- 源: https://docs.bannerlordmodding.lt/3d/environment/ | 抓取日期: 2026-09-09 -->
...
`lt` marks my projects, so it's easy to find  
`hrodno` - unique helmet name  
...
`src` - for all files received from the modeller. Usually it's zip, textures and fbx files in original names. It's just like a backup  
`fbx` - [exported from Blender fbx files](/3d/export_to_fbx/), ready to be imported into the Editor  
...
![](https://docs.bannerlordmodding.lt/pics/2410020935.png)
