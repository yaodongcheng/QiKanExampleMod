...
<!-- 源: https://docs.bannerlordmodding.lt/gauntletui/widgets/ | 抓取日期: 2026-09-09 -->

Screen elements, main building blocks of [Prefabs](/gauntletui/prefabs)

## Links

* [Widgets from unnoficial BL docummentation](https://docs.bannerlordmodding.com/_gauntlet/widget.html)
...
X and Y here are not measured in the screen pixels. This is something else. On my screen with resolution 3440x1440 X and Y for this measurement system is ~2200x1000. Use 'scaled' versions of the attributed to operate in real screen pixels.
...
Using the same Attribute twice in the same Widget will crash the game

Using wrong/non-existant Attribute will crash the game

It seems it's not allowed to use the same variable on the several attributes (in the same widget):
