...
<!-- 源: https://docs.bannerlordmodding.lt/guides/scale_world_map_entities/ | 抓取日期: 2026-09-09 -->

Huge thanks to **Iberian Wolf** for doing majority of the research where info on how to scale the entities is stored and **order\_without\_power** for helping me to solve ranged siege engines scaling in the code.
...
![](https://docs.bannerlordmodding.lt/pics/2403031901.png)
...
![](https://docs.bannerlordmodding.lt/pics/2403031912.png)
...
![](https://docs.bannerlordmodding.lt/pics/2403031920.png)
...
![](https://docs.bannerlordmodding.lt/pics/trebuchet_0.5b.gif)
...
![](https://docs.bannerlordmodding.lt/pics/2403031935.png)

It is necessary to scale down projectiles also, without it it looks like this:

![](https://docs.bannerlordmodding.lt/pics/2403031937.png)
