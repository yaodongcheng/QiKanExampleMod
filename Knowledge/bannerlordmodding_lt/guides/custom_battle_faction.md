...
<!-- 源: https://docs.bannerlordmodding.lt/guides/custom_battle_faction/ | 抓取日期: 2026-09-09 -->
...
![A custom faction (Rhodok) selectable in Custom Battle, with its bear crest in the faction row](https://docs.bannerlordmodding.lt/pics/rhodok_custom_battle.png)
...
Even the land list is hard-coded
...
XML comments must never contain a double hyphen `--`
