...
<!-- 源: https://docs.bannerlordmodding.lt/guides/custom_creature_animation/ | 抓取日期: 2026-09-09 -->
...
In the Modding Kit, `quad_movement` is a CLIP USAGE, not a Flag
...
Byte size is a reliable empty-bake detector
...
Do not rename a clip inside the Modding Kit
...
That leading space in the elephant's bone name is real
