...
<!-- 源: https://docs.bannerlordmodding.lt/guides/custom_main_menu/ | 抓取日期: 2026-09-09 -->

![](https://docs.bannerlordmodding.lt/pics/initial_screen_demo.gif)

This guide is for 1.3.13
...
![](https://docs.bannerlordmodding.lt/pics/2601170901a.png)
...
![](https://docs.bannerlordmodding.lt/pics/2601170901b.png)
...
![](https://docs.bannerlordmodding.lt/pics/2601170901c.png)

Following guide is for 1.2.12 [OUTDATED]
...
![](https://docs.bannerlordmodding.lt/pics/2402261842.png)

You will get a lot of files:

![](https://docs.bannerlordmodding.lt/pics/2402261848.png)

Import FBX into the Blender:

![](https://docs.bannerlordmodding.lt/pics/2402261844.png)
...
![](https://docs.bannerlordmodding.lt/pics/2402261850.png)

I added new helmet in the Blender. Make sure it's parent is set to the intro\_scene\_node.

![](https://docs.bannerlordmodding.lt/pics/2402261853.png)
...
![](https://docs.bannerlordmodding.lt/pics/2402261859.png)
...
Le Profyteur: after you can make a animation on blender and export with your mesh, after you can add a play anim script to play the clip
...
MAJOR PROBLEM: Editor fails to start

For me on the start the Editor is throwing zillions of such errors when 'intro\_scene' model is imported:

![](https://docs.bannerlordmodding.lt/pics/2402261945.png)
...
To make it start, delete intro\_scene\_geo.tpac file from your mod's /Assets folder (~55mb)

### Movement

To activate the cloth physics add VertexAnimator Script and set it like this:

![](https://docs.bannerlordmodding.lt/pics/2402262008.png)
...
![](https://docs.bannerlordmodding.lt/pics/2402261950.png)

Import texture files with the same names, and new textures will be applied automatically.

Renaming the texture and creating a custom material will disable cloth physics

## Scene saving

Save as a new scene with the same name main\_menu\_a in your mod's folder. It will be used on the next game start.

In 1.2.9 if you try to save (Save as...) this scene, the Editor will crash.

Add a terrain to avoid this:

![](https://docs.bannerlordmodding.lt/pics/2402262011.png)
...
* Change the scene as you like it. Use useful [camera\_instance controls](/editor/scenes/#camera-instance) to see the changes in real time.
* Custom Music in Main Menu guide [here](/modding/sound/#custom-music-in-main-menu)

Bullero: some effects animations scripts not work in menu scenes
