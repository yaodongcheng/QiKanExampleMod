...
<!-- 源: https://docs.bannerlordmodding.lt/guides/custom_audio_with_lipsync/ | 抓取日期: 2026-09-09 -->
...
I use [ChatGPT](https://chat.openai.com) to generate texts and [Synthesia](https://app.synthesia.io/) to convert text to audio. There are other tools to accomplish the same task. Choose what you like.

Save your generated audio to the OGG file. I use [Audacity](https://www.audacityteam.org/) for this task.

Audacity usage

![](https://docs.bannerlordmodding.lt/pics/ajka2ev.png)

![](https://docs.bannerlordmodding.lt/pics/bUp5TiZ.png)

## File names

Based on the file name game engine selects which file to use. File names should follow the rules.

File name format: CULTURE\_GENDER\_VOICETYPE\_ID.ogg

VOICETYPE (TW calls them personas) are described in Sandbox\ModuleData\voice\_strings.xml. There are 4 of them:
...
When you have audio file(s) you need, use [Rhubarb Lip Sync](https://github.com/DanielSWolf/rhubarb-lip-sync) to generate XML with LipSync data from your OGG file(s).
...
![](https://docs.bannerlordmodding.lt/pics/ztfpJ1n.png)
...
\ModuleData\Languages\language\_data.xml:
...
\ModuleData\Languages\VoicedLines\voiced\_lines\_en.xml:
...
Copy your XML/OGG file(s) to \ModuleData\Languages\VoicedLines\EN\PC and add information about it/them into \ModuleData\Languages\VoicedLines\voiced\_lines\_en.xml

## Playing audio in dialogs

Audio should play automatically in dialogs if everything is set up properly

If you need to change text in the condition delegate, do like this:
...
AUDIO\_ID is from voiced\_lines\_en.xml . Make your own.

textLine is some text.

If you leave textLine empty, you will get such error:

![](https://docs.bannerlordmodding.lt/pics/zvLoWia.png)

Then in AddDialogLine use VOICED\_LINE like this:
