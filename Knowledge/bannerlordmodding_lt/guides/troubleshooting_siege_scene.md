...
<!-- 源: https://docs.bannerlordmodding.lt/guides/troubleshooting_siege_scene/ | 抓取日期: 2026-09-09 -->
...
![](https://docs.bannerlordmodding.lt/pics/2402271318.png)

Butterlib shows:

![](https://docs.bannerlordmodding.lt/pics/2402271313.png)

Log suggests the same:

![](https://docs.bannerlordmodding.lt/pics/2402271325.png)
...
![](https://docs.bannerlordmodding.lt/pics/2402271322.png)

dnSpy shows that this deployment point is looking for weapons but has no weapons assigned:

![](https://docs.bannerlordmodding.lt/pics/2402271327.png)
...
![](https://docs.bannerlordmodding.lt/pics/2402271330.png)

Example with another entity

![](https://docs.bannerlordmodding.lt/pics/2402281753.png)

In the scene, there are 7 such entities with the same name:

![](https://docs.bannerlordmodding.lt/pics/2402271332.png)

It's possible to find out the problematic entity by it's coordinates:

![](https://docs.bannerlordmodding.lt/pics/2402271335.png)
...
![](https://docs.bannerlordmodding.lt/pics/siege_scene_crash_trb.gif)
