...
<!-- 源: https://docs.bannerlordmodding.lt/guides/how_to_remove_native_kingdoms/ | 抓取日期: 2026-09-09 -->
...
Make a full backup of your /Modules/YOUR\_MOD folder
...
should be some other clan, let's say Faction.clan\_empire\_north\_1

Do this to all towns/castles, do not change the capital, keep it to the current kingdom's ruler, in our case: clan\_aserai\_1 / Quyaz town\_A1

Make sure you have assigned ruling clan clan...\_1 to the capital
...
Make a full backup of your /Modules/YOUR\_MOD folder under a new name

## Heroes/Lords/Clans

Remove all clans/lords/heroes except clan\_1 and it's ruler and his wife.

I leave ruler and the spouse because I was not able to remove them without crashes. Later we will rename them to other leaders/clans keeping their native IDs.

### heroes.xslt

Removing all native Aserai heroes:
...
Leaving lord\_3\_1 (ruler) and lord\_3\_2 (his wife) intact.
...
Assign ruling clan\_1 to another Kingdom AND comment out the original Kingdom

Example with Aserai:

Assigning clan to a new Kingdom in clans.xslt (super\_faction=...(make sure you have such a kingdom)):
