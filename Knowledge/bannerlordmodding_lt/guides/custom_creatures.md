...
<!-- 源: https://docs.bannerlordmodding.lt/guides/custom_creatures/ | 抓取日期: 2026-09-09 -->
...
Say the last part out loud before you start
...
name keeps its inherited value. Its defaults are guarded behind a "has a base\_monster" check, so
...
A reskin inherits the donor's behaviour, not just its animations
...
* **Artem**, author of **ADOD\_Beasts**, whose war elephant TAOM licensed. The elephant is the
