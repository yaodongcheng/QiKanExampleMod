...
<!-- 源: https://docs.bannerlordmodding.lt/editor/mesh2hmap/ | 抓取日期: 2026-09-09 -->

![](https://docs.bannerlordmodding.lt/pics/2601071435a.png)
...
Blender v3.6.23 used in this guide.

![](https://docs.bannerlordmodding.lt/pics/2601071435b.png)

## Define mesh's vertical axis

Go to Scripting:

![](https://docs.bannerlordmodding.lt/pics/2601071435c.png)
...
![](https://docs.bannerlordmodding.lt/pics/2601071435d.png)

You should get something like this:

![](https://docs.bannerlordmodding.lt/pics/2601071435e.png)

The one with the smallest range is our vertical axis.

Y happens to be the vertical axis of the bounding box. It does not match the usual Z axis, but it is ok.
...
![](https://docs.bannerlordmodding.lt/pics/2601071435f.png)

On the numpad press 7 then 5.

On the left top corner you should see:

![](https://docs.bannerlordmodding.lt/pics/2601071435g.png)
...
![](https://docs.bannerlordmodding.lt/pics/2601071435h.png)

## Set Up a Height-Based Material

Select the terrain mesh:

![](https://docs.bannerlordmodding.lt/pics/2601071435i.png)

Go to Material Properties tab (red sphere icon):

![](https://docs.bannerlordmodding.lt/pics/2601071435j.png)

Click New material:

![](https://docs.bannerlordmodding.lt/pics/2601071435k.png)

## Configure Height-to-Color Shading

Go to `Shading`:

![](https://docs.bannerlordmodding.lt/pics/2601071435l.png)

Delete the default Principled BSDF node. Click on it and the press Del to delete it:

![](https://docs.bannerlordmodding.lt/pics/2601071435m.png)
...
* Separate XYZ → YOUR\_VERTICAL\_AXIS (in our case it's Y) → Color Ramp
* Color Ramp → Color → Emission → Strength
* Emission → Material Output (Surface)

Should look like this:

![](https://docs.bannerlordmodding.lt/pics/2601071435n.png)

If your vertical axis is Z - connect Z to the Color Ramp

* Set/Leave ColorRamp to Linear, black on left, white on right.
* Adjust handles to match your terrain min/max height.

![](https://docs.bannerlordmodding.lt/pics/2601071435o.png)

Should see the result:

![](https://docs.bannerlordmodding.lt/pics/2601071435p.png)

If you mapped your vertical axis incorrectly:

You will see something like:  
![](https://docs.bannerlordmodding.lt/pics/2601071435q.png)
...
![](https://docs.bannerlordmodding.lt/pics/2601071435w.png)

Should see at the bottom:

![](https://docs.bannerlordmodding.lt/pics/2601071435z.png)

your CPU will be 100% for a few moments.

In the bottom left corner you should see your generated heightmap:

![](https://docs.bannerlordmodding.lt/pics/2601071435z2.png)

## Save the PNG

After baking, in the UV Editing → Image → Save As → choose PNG:

![](https://docs.bannerlordmodding.lt/pics/2601071435z3.png)
