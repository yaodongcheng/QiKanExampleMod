...
<!-- 源: https://docs.bannerlordmodding.lt/editor/battle_scene_grid/ | 抓取日期: 2026-09-09 -->
...
![](https://docs.bannerlordmodding.lt/pics/2411201517.png)
...
Many scenes can have same map\_indices and game selects the scene by such algorithm:

![](https://docs.bannerlordmodding.lt/pics/2411201532.png)

## Orientation

GREEN channel should define the orientation how parties enter the battle map - from which side.

Some info about it [here](https://discord.com/channels/411286129317249035/761302555308720148/932014023199850586)

![](https://docs.bannerlordmodding.lt/pics/2411201540.png)

## sp\_battle\_scenes.xml
...
It should be possible to overwrite native sp\_battle\_scenes.xlm with XSLT, but that leaves the possibility that scenes will be loaded from other mods.
...
![](https://docs.bannerlordmodding.lt/pics/2411201715.png)

Examples:

![](https://docs.bannerlordmodding.lt/pics/2411201736.png)
