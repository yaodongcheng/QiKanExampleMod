...
<!-- 源: https://docs.bannerlordmodding.lt/editor/terrain/ | 抓取日期: 2026-09-09 -->
...
![](https://docs.bannerlordmodding.lt/pics/UE3sZpn.png)

When creating new terrain you will see:

![](https://docs.bannerlordmodding.lt/pics/yytdVZT.png)
...
![](https://docs.bannerlordmodding.lt/pics/ZiL27AD.png)
...
[Swan [IAF]](https://discord.com/channels/411286129317249035/761302555308720148/1276198457408753755) just be sure not to exceed 256x256 for single node dim otherwise the chances for the scene to get corrupted will skyrocket
...
TurqoiseTurtle: I deleted the main map terrain and just generated a new terrain and this happens, its completely dark and no paint layer is visible

![](https://docs.bannerlordmodding.lt/pics/2403140806.png)

Swan [ADOD/IAF]: go to your vista texture and rename the tileset to 'none' then add a basic white albedo texture in the vista category
