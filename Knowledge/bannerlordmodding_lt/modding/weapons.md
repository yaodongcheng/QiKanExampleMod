...
<!-- 源: https://docs.bannerlordmodding.lt/modding/weapons/ | 抓取日期: 2026-09-09 -->

* [Official doc](https://moddocs.bannerlord.com/asset-management/weapon_smithing/)
...
![](https://docs.bannerlordmodding.lt/pics/2509132127.png)
...
![](https://docs.bannerlordmodding.lt/pics/2509132134.png)
...
Comments inside the Flags tag are not allowed. XML will not be loaded. Click for example:
...
<Flags Civilian="true" /> in the <Items><CraftedItem> does not work

### Javelins

<Flag name="NotStackable" type="ItemFlags" /> when used on the Blade of the javelin - AI will not throw those javelins in battle.

BladeData - holster\_mesh

![](https://docs.bannerlordmodding.lt/pics/2509151011.png)
...
* ThrowingAxe
* OneHandedPolearm
* OneHandedPolearm\_JavelinAlternative
* TwoHandedPolearm
* TwoHandedPolearm\_Couchable
* TwoHandedPolearm\_Pike
* TwoHandedPolearm\_Bracing
* TwoHandedPolearm\_Thrown
* Javelin
* Mace
* TwoHandedMace
...
TeaLeaf: In case anyone else needs this, I did find the function to call: MBItem.GetItemUsageSetFlags
...
By creating custom variants of the game's item\_usage\_sets with these flags, you can dynamically assign them to a MissionWeapon. To do this, you can use reflection like so:
...
If a mounted agent has a one-handed weapon and a lance, you can "disable" the one-handed weapon by creating a custom variant of the onehanded\_block\_shield\_swing\_thrust usage set and adding the requires\_no\_mount flag. Assigning this usage set to the one-handed weapon's MissionWeapon will make it unusable while mounted.
...
Moreover, you can disable weapons for agents on foot by applying the requires\_mount flag in the usage set variant.
...
* Use the weapon code in XML file (include in your mod within  type file)

Example

/MOD\_FOLDER/SubModule.xml
...
/MOD\_FOLDER/ModuleData/items/my\_custom\_daggers.xml
...
You can use CTRL+v to paste XML code back to the Smithy and see the weapon from the code
