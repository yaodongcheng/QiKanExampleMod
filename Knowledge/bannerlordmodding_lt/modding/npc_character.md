...
<!-- 源: https://docs.bannerlordmodding.lt/modding/npc_character/ | 抓取日期: 2026-09-09 -->
...
* is\_female (default false)
* is\_hero
* occupation
* is\_basic\_troop - it gets checked in the encyclopedia unit page for troops for determining the root of the troop tree and in the "Rival Gang Moving In" issue quest for determining what troops should spawn according to the mission difficulty
* culture
* is\_hidden\_encyclopedia
* skill\_template
