...
<!-- 源: https://docs.bannerlordmodding.lt/modding/heroes/ | 抓取日期: 2026-09-09 -->

[TaleWorlds.CampaignSystem.Hero Class Reference](https://apidoc.bannerlord.com/v/1.1.0/class_tale_worlds_1_1_campaign_system_1_1_hero.html) [1.2.7](https://apidoc.bannerlord.com/v/1.2.7/class_tale_worlds_1_1_campaign_system_1_1_hero.html) [1.3.4](https://apidoc.bannerlord.com/v/1.3.4/class_tale_worlds_1_1_campaign_system_1_1_hero.html)
...
![](https://docs.bannerlordmodding.lt/pics/ckk9hK4.png)
...
private (why TW? WHY??) TraitLevelingHelper.AddPlayerTraitXPAndLogEntry
...
![](https://docs.bannerlordmodding.lt/pics/JCtw0gl.png)

![](https://docs.bannerlordmodding.lt/pics/YuKhQw2.png)

![](https://docs.bannerlordmodding.lt/pics/47ysvNJ.png)
...
You need to create sprites with that same naming scheme as well. "TraitStringId\_-2", "TraitStringId.-1", etc...

Kemo III: Though, I just realized parts of this might be outdated and don't work any more.
...
![](https://docs.bannerlordmodding.lt/pics/LggRpKJ.png)
...
A lof of stuff done in NotablePowerModel ([DefaultNotablePowerModel Class](https://apidoc.bannerlord.com/v/1.1.0/class_tale_worlds_1_1_campaign_system_1_1_game_components_1_1_default_notable_power_model.html)), example:
...
To kill a player, make sure do this before KillCharacterAction:
...
KillCharacterAction.KillCharacterActionDetail.WoundedInBattle - kill the player after some time
...
* faction - clan, in a format: Faction.CLAN\_ID
* spouse - Hero.SPOUSE\_HERO\_ID
* father - Hero.FATHER\_HERO\_ID
* mother - Hero.MOTHER\_HERO\_ID
* alive - default true, set to false for dead hero
* text - Encyclopedia text

How to properly make a lord dead in XML?

alive="false" makes him dead, but in description it writes: HERO\_NAME is member of ...
...
sandboxcore\_equipment\_sets.xslt
