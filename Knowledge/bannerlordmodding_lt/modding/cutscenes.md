...
<!-- 源: https://docs.bannerlordmodding.lt/modding/cutscenes/ | 抓取日期: 2026-09-09 -->

![](https://docs.bannerlordmodding.lt/pics/NBh2a8Y.png)  
We are waiting... (No pressure ![😁](https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/svg/1f601.svg ":grin:"))
...
the folders that start with scn\_cutscene
...
The technical aspect of working for a cutscene is different than normal scene, in the cutscene there are special agents called cutscene\_agent which will be called by code. They have animation instances for initial start of the scene, positive outcome, negative outcome.

## Animation instances

You can find animation instances inside Native\ModuleData\action\_sets the ones that start with act.
