...
<!-- 源: https://docs.bannerlordmodding.lt/modding/xml/ | 抓取日期: 2026-09-09 -->

* [XML Editor (Official)](https://moddocs.bannerlord.com/bestpractices/xml_editor/)

![](https://docs.bannerlordmodding.lt/pics/yZvCYRb.png)
...
Make ugly XMLs easier to work with!

![](https://docs.bannerlordmodding.lt/pics/xENrxdr.png)

Notepad++ with XML Tools plugin

![](https://docs.bannerlordmodding.lt/pics/M6QGjrP.png)

Online tools:

* [Make it readable](https://www.liquid-technologies.com/online-xml-formatter)
* [Fix Tab spaces](https://jsonformatter.org/xml-formatter)
...
In order XSLT to be applied, there should be a XML file with the same name in the same folder.  
XML could be empty.

![](https://docs.bannerlordmodding.lt/pics/2402171157.png)
...
* [XSLT Usage Tutorial](https://moddocs.bannerlord.com/bestpractices/xslt_usage_tutorial/)
* [Validation](https://www.freeformatter.com/xsl-transformer.html)
* [Update Attribute in Elements](https://gist.github.com/cpburnz/e11fa0b792e81ee071d443b64e06516f)
* [Remove Attribute from Elements](https://gist.github.com/cpburnz/6cc05c4a0ea4d66e875ccbebbd6eda4a)
...
In your Module data create folder **npc\_lords**
