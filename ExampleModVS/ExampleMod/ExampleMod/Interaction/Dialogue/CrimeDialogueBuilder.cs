    ...
    public static class CrimeDialogueBuilder
    {
        ...
        private static void BuildDiscoveryNode(List<DialogueInjector.DialogueNode> nodes, PlaceholderResolver r, IntentContext ctx)
        {
            ...
            if (evt.InitiatorIsPlayer)
            {
                ...
                nodes.Add(BuildConfessNode(r, ctx));
                nodes.Add(BuildRestitutionDetailNode(r, ctx, "restitution_detail", "continue_chat"));
            }
        ...
        private static DialogueInjector.DialogueNode BuildConfessNode(PlaceholderResolver r, IntentContext ctx)
        {
            return new DialogueInjector.DialogueNode
            {
                ...
                Transitions = new List<DialogueInjector.DialogueTransition>
                {
                    ...
                    new DialogueInjector.DialogueTransition { PlayerLine = "（转身就走）", Action = "INTENT:WalkAway", NextNode = "" },
                }
            };
        }

        /// <summary>赔偿明细 node：NPC 解释赔偿金额怎么算的 → 玩家选接受/不接受</summary>
        private static DialogueInjector.DialogueNode BuildRestitutionDetailNode(PlaceholderResolver r, IntentContext ctx, string nodeId, string declineNode)
        {
            return new DialogueInjector.DialogueNode
            {
                Id = nodeId,
        ...
        private static void BuildReportNode(List<DialogueInjector.DialogueNode> nodes, PlaceholderResolver r, IntentContext ctx)
        {
            ...
            DialogueInjector.DialogueNode node = new DialogueInjector.DialogueNode
            {
                ...
                Transitions = new List<DialogueInjector.DialogueTransition>
                {
                    ...
                    new DialogueInjector.DialogueTransition { PlayerLine = "还没查到什么。", NpcResponse = r.Resolve("那你再去看看。{InvestigationProgressWord}。"), Action = "NONE", NextNode = "continue_chat" },
                    new DialogueInjector.DialogueTransition
                    {
                        PlayerLine = "我还有事。",
        ...
        private static void BuildBountyOfferNode(List<DialogueInjector.DialogueNode> nodes, PlaceholderResolver r, IntentContext ctx)
        {
            nodes.Add(new DialogueInjector.DialogueNode
            {
                ...
                Transitions = new List<DialogueInjector.DialogueTransition>
                {
                    new DialogueInjector.DialogueTransition { PlayerLine = "我接这个悬赏！", NpcResponse = r.Resolve("好！人就交给{SpeakerPlayerAddr}了。"), Action = "INTENT:AcceptBountyQuest", NextNode = "continue_chat" },
                    new DialogueInjector.DialogueTransition { PlayerLine = "我先想想。", Action = "NONE", NextNode = "continue_chat" },
                }
            });
            nodes.Add(BuildContinueChatNode(r));
        }
        ...
        private static void BuildRetaliationNode(List<DialogueInjector.DialogueNode> nodes, PlaceholderResolver r, IntentContext ctx)
        {
            ...
            if (evt.SuspectIsPlayer)
            {
                ...
                transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = r.Resolve("我赔钱！你说个数。"), Action = "NONE", NextNode = "restitution_detail" });
                transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "这事可以商量……", NpcResponse = r.Resolve("商量？有什么好商量的？"), Action = "INTENT:Settle", NextNode = "continue_chat" });
                transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "我走了。", Action = "INTENT:WalkAway", NextNode = "" });
            }
            else
            {
                ...
                transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "我带人去！", NpcResponse = r.Resolve("好！有{SpeakerPlayerAddr}带队，那{SuspectDescription}跑不了。"), Action = "INTENT:LeadRetaliation", NextNode = "close_window" });
                transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "我没空。", Action = "NONE", NextNode = "close_window" });
            }
            ...
            // 赔钱明细 node：报复阶段也需要解释金额构成（与 confess/confront 一致）
            if (evt.SuspectIsPlayer)
            {
                nodes.Add(BuildRestitutionDetailNode(r, ctx, "restitution_detail", "continue_chat"));
            }
            ...
            PlaceholderResolver r, IntentContext ctx)
        {
            ...
            {
                node.Transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "（给些钱）这事你别往外说……", NpcResponse = r.Resolve("……好吧，{SpeakerSelfRef}什么也没看见。"), Action = "INTENT:SilenceWitness", NextNode = "continue_chat" });
                node.Transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "（威胁）你什么也没看见，明白吗？", NpcResponse = r.Resolve("明白、明白……{SpeakerSelfRef}一个字也不说。"), Action = "INTENT:SilenceWitness", NextNode = "continue_chat" });
                node.Transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "当我没来过。", Action = "INTENT:WalkAway", NextNode = "" });
            }
            else if (evt.WitnessesSilenced)
            {
                node.NpcLine = r.Resolve("（紧张地看了看四周）{SpeakerPlayerAddr}找错人了。{SpeakerSelfRef}什么也不知道。", "NpcLine");
                node.Transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "……好吧。", Action = "NONE", NextNode = "continue_chat" });
            }
            else
            {
                node.Transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "能说说那人的特征吗？", NpcResponse = r.Resolve("那人……{SuspectDescription}。"), Action = "NONE", NextNode = "continue_chat" });
                node.Transitions.Add(new DialogueInjector.DialogueTransition { PlayerLine = "谢谢，我知道了。", Action = "NONE", NextNode = "continue_chat" });
            }

            nodes.Add(node);
            nodes.Add(BuildContinueChatNode(r));
            return new DialogueInjector.DialogueInjectScript { EntryOption = "听说你看到了……？", EntryNode = "start", Nodes = nodes };
        }
            ...
            PlaceholderResolver r, IntentContext ctx)
        {
            List<DialogueInjector.DialogueNode> nodes = new List<DialogueInjector.DialogueNode>
            {
                new DialogueInjector.DialogueNode
                {
                    ...
                    Transitions = new List<DialogueInjector.DialogueTransition>
                    {
                        new DialogueInjector.DialogueTransition { PlayerLine = "跟我走一趟，村长找你有事。", NpcResponse = r.Resolve("什么？！{SpeakerSelfRef}什么也没干……"), Action = "INTENT:LureArrest", NextNode = "continue_chat" },
                        new DialogueInjector.DialogueTransition { PlayerLine = "快跑！村里人在抓你。", NpcResponse = r.Resolve("什么？！……谢了！"), Action = "INTENT:BetrayQuest", NextNode = "continue_chat" },
                        new DialogueInjector.DialogueTransition { PlayerLine = "没什么。", Action = "INTENT:WalkAway", NextNode = "" },
                    }
                }
            };
            nodes.Add(BuildContinueChatNode(r));
            return new DialogueInjector.DialogueInjectScript { EntryOption = "（打量了一下）……", EntryNode = "start", Nodes = nodes };
        }
            ...
            PlaceholderResolver r, IntentContext ctx)
        {
            ...
            nodes.Add(new DialogueInjector.DialogueNode
            {
                ...
                Transitions = new List<DialogueInjector.DialogueTransition>
                {
                    new DialogueInjector.DialogueTransition { PlayerLine = "详细说说？", NpcResponse = r.Resolve("我就知道这么多……"), Action = "NONE", NextNode = "continue_chat" },
                    new DialogueInjector.DialogueTransition { PlayerLine = "哦。", Action = "NONE", NextNode = "continue_chat" },
                }
            });
            nodes.Add(BuildContinueChatNode(r));

            return new DialogueInjector.DialogueInjectScript { EntryOption = "最近村里有什么新鲜事？", EntryNode = "start", Nodes = nodes };
        }
            ...
            WorldEvent worldEvt = null, Agent speakerAgent = null)
        {
            ...
            nodes.Add(new DialogueInjector.DialogueNode
            {
                ...
                Transitions = escalated
                    ...
                    {
                        new() { PlayerLine = "（拔剑）谁敢拦我！", NpcResponse = r.Resolve("{SPEAKER_PLAYER_ADDR}疯了！快叫人！"), Action = "INTENT:FightVillagers", NextNode = "" },
                        new() { PlayerLine = "我认罚。（100 第纳尔）", NpcResponse = r.Resolve("扰乱治安，罚款100第纳尔。算你识相。别再来了。"), Action = "INTENT:PayRestitution", ActionParam = "alert_fine", NextNode = "" },
                        new() { PlayerLine = "我没钱。要抓就抓吧。", NpcResponse = r.Resolve("没钱还敢闹事？！来人，把他关进地牢！"), Action = "INTENT:SurrenderJail", ActionParam = "surrender_jail", NextNode = "" },
                    }
                    : new List<DialogueInjector.DialogueTransition>
                    {
            ...
            return new DialogueInjector.DialogueInjectScript { EntryNode = "start", Nodes = nodes };
        }
            ...
            PlaceholderResolver r, ConfrontationType intent, PlayerActionType action, WorldEvent worldEvt = null)
        {
            ...
            switch (intent)
            {
                case ConfrontationType.Deter:
                    ...
                    transitions.Add(new() { PlayerLine = complyLine, NpcResponse = r.Resolve(complyResp), Action = "INTENT:Comply", ActionParam = "comply", NextNode = "" });
                    transitions.Add(new() { PlayerLine = "关你什么事？（挑衅）", NpcResponseOnSuccess = r.Resolve("……算了。"), NpcResponseOnFail = r.Resolve("来人！这有个闹事的！"), Action = "INTENT:Threat", NextNode = "" });
                    // WorldEvent Stage >= Active（玩家上次走了，这次升级围堵），加入投降选项
                    if (worldEvt != null && worldEvt.Stage >= EventStage.Active)
                    {
                        transitions.Add(new() { PlayerLine = "我认罚。（100 第纳尔）", NpcResponse = r.Resolve("扰乱治安，罚款100第纳尔。算你识相。别再来了。"), Action = "INTENT:PayRestitution", ActionParam = "alert_fine", NextNode = "" });
                        transitions.Add(new() { PlayerLine = "我没钱。要抓就抓吧。", NpcResponse = r.Resolve("没钱还敢闹事？！来人，把他关进地牢！"), Action = "INTENT:SurrenderJail", ActionParam = "surrender_jail", NextNode = "" });
                    }
                    break;
                ...
                case ConfrontationType.Recover:
                    ...
                    transitions.Add(new() { PlayerLine = r.Resolve("你哪只眼睛看见的？"), NpcResponseOnSuccess = r.Resolve("……{SPEAKER_SELF}可能看错了。"), NpcResponseOnFail = r.Resolve("{SPEAKER_SELF}两只眼睛都看见了！"), Action = "INTENT:CharmDefense", NextNode = "continue_chat" });
                ...
                case ConfrontationType.Stop:
                    ...
                    transitions.Add(new() { PlayerLine = "他先惹我的。", NpcResponseOnSuccess = r.Resolve("……下次再动手没这么好说话。"), NpcResponseOnFail = r.Resolve("在{SPEAKER_SELF}眼皮底下动手，就得有个说法！"), Action = "INTENT:CharmDefense", NextNode = "continue_chat" });
                    transitions.Add(new() { PlayerLine = "（拔剑）谁敢拦我！", NpcResponse = r.Resolve("{SPEAKER_PLAYER_ADDR}疯了！快叫人！"), Action = "INTENT:FightVillagers", NextNode = "" });
                    break;
            }
            ...
            return new DialogueInjector.DialogueNode
            {
                ...
                Transitions = hasStolenItems
                    ? new List<DialogueInjector.DialogueTransition>
                    {
                        ...
                        new() { PlayerLine = "那是我的东西！", NpcResponse = r.Resolve("你的？上面还写着{TARGET}的名字呢！"), Action = "NONE", NextNode = "continue_chat" },
                    }
                    : new List<DialogueInjector.DialogueTransition>
                    {
