...
| Gauntlet UI / HUD | [wheels.d/ui.md](wheels.d/ui.md) | 双版本 XML 兼容、VM↔XML 同步铁律、HUD 五元素与显隐、AgentHudVM、性能距离分级、原生弹窗面板、富文本、NinjaNotification 书信流、**GauntletLayer 层序表（原生层序实测）**、**贴内容气泡（CoverChildren+MaxWidth）** |
